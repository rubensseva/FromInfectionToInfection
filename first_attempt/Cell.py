...
class Cell:
    ...
    def apply_rand_force(self):
        ...
        self.shape.body.apply_impulse_at_local_point((rand_x, rand_y), point=(-rand_x, -rand_y))

    def split(self):
        self.age = init_age
        rand_x = (0.5 - random.random()) / 10
        rand_y = (0.5 - random.random()) / 10
        return Cell(self.shape.body.position.x + rand_x, self.shape.body.position.y + rand_y)
